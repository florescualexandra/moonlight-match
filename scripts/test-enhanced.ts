...
const createMockUser = (formData: Record<string, string>) => ({
  id: 'test-user-id',
...
async function runTests() {
  console.log('🧪 Starting Full Enhanced Matching Algorithm Tests...\n');
...
// Run the tests
console.log('🚀 Starting Full Enhanced Matching Algorithm Test Suite...\n');
