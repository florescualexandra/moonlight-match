        ...
        <div className="max-w-4xl w-full mx-auto flex flex-col md:flex-row bg-white/5 rounded-3xl shadow-2xl overflow-hidden mt-24 mb-24">
          ...
          <div className="flex-1 flex flex-col justify-center items-center md:items-start px-10 py-14 bg-white/90">
            ...
            <div className="flex flex-col gap-5 w-full max-w-xs">
              ...
              <Link href="/chats" className="px-8 py-4 rounded-full bg-transparent text-[#D4AF37] font-bold text-xl hover:bg-[#D4AF37]/10 transition shadow border-2 border-[#D4AF37] text-center">My Chats</Link>
              <Link href="/user/profile" className="px-8 py-4 rounded-full bg-transparent text-[#D4AF37] font-bold text-xl hover:bg-[#D4AF37]/10 transition shadow border-2 border-[#D4AF37] text-center">Edit My Profile</Link>
